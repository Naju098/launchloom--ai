      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-3">
        {products.map((product, index) => (
          <motion.article
            ...
            whileHover={{ y: -6 }}
            className="venture-card rounded-2xl p-4"
          >
            ...
            <div className="p-2 pb-3 pt-5">
              <div className="flex items-start justify-between gap-3">
                <div>
                  <p className="text-[11px] font-bold uppercase tracking-[0.15em] text-[var(--va-green)]">
                    {product.category}
                  </p>
                  <h3 className="mt-2 text-xl font-black text-[var(--va-text)]">
                    {product.name}
                  </h3>
                </div>
                {/* Match score ring */}
                <div className="relative flex h-14 w-14 items-center justify-center rounded-full bg-[var(--va-elevated)]">
              ...
              <div className="mt-4 grid grid-cols-3 gap-2">
                {[
                  ...
                  <div key={label} className="rounded-xl bg-[var(--va-elevated)] px-2 py-3 text-center transition-colors hover:bg-[var(--va-green-dim)]">
              ...
              <div className="mt-5 flex items-end justify-between border-t border-[var(--va-border)] pt-4">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="grid h-11 w-11 place-items-center rounded-xl bg-[var(--va-green-dim)] text-[var(--va-green)] transition-colors hover:bg-[var(--va-green)] hover:text-[var(--va-base)]"
              ...
              <div className="mt-4 inline-flex items-center gap-2 rounded-lg bg-[var(--va-green-dim)] px-3 py-1.5 text-xs font-bold text-[var(--va-green)]">
